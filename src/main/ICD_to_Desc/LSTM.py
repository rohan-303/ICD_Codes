...
data_dir = '/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Results/ICD_to_Desc/LSTM'
checkpoint_dir = '/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Results/ICD_to_Desc/LSTM/checkpoints'
results_file = "/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Results/ICD_to_Desc/LSTM/results.txt"
...
def objective(trial):
    ...
    train_loss,val_loss,train_accuracy,train_precision,train_recall,train_f1score,test_accuracy,test_precision,test_recall,test_f1score,val_avg_loss = lstm_build.train(model,pred='full')
...
lstm_build = RNN_Build(num_epochs=epochs, train_loader=train_loader, test_loader=test_loader, lr=lr, data_dir=data_dir,save_ckpt_dir=checkpoint_dir,vocab_size=vocab_size)

train_loss,test_loss,train_accuracy,train_precision,train_recall,train_f1score,test_accuracy,test_precision,test_recall,test_f1score,val_avg_loss = lstm_build.train(model,pred='full')

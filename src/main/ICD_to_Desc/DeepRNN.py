...
data_dir = '/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Results/ICD_to_Desc/DeeepRNN'
checkpoint_dir = '/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Results/ICD_to_Desc/DeeepRNN/checkpoints'
results_file = "/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Results/ICD_to_Desc/DeeepRNN/results.txt"

with open(results_file, "w") as file:
    file.write("")

df = pd.read_csv("/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Dataset/icd10-codes-and-descriptions/Tokens_ICD2Desc.csv", index_col=False)
...
y = df["desc_padded"].tolist()
X = df["code_padded"].tolist()
...
def objective(trial):
    ...
    model = SeqModel(vocab_size=vocab_size,embed_size=embed_size,hidden_size=hidden,output_size=output_size,batch_size=batch_size,act='relu',model_type='deeprnn',num_layers=num_layers) 
    ...
    train_loss,val_loss,train_accuracy,train_precision,train_recall,train_f1score,test_accuracy,test_precision,test_recall,test_f1score,val_avg_loss = rnn_build.train(model,pred='full')
...
train_loss,test_loss,train_accuracy,train_precision,train_recall,train_f1score,test_accuracy,test_precision,test_recall,test_f1score,val_avg_loss = rnn_build.train(model,pred='full')

...
data_dir = '/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Results/ICD_to_Desc/BiRNN'
checkpoint_dir = '/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Results/ICD_to_Desc/BiRNN/checkpoints'
results_file = "/home/careinfolab/Dr_Luo/Rohan/ICD_Codes/Results/ICD_to_Desc/BiRNN/results.txt"
...
def objective(trial):
    ...
    model = SeqModel(vocab_size=vocab_size,embed_size=embed_size,hidden_size=hidden,output_size=output_size,batch_size=batch_size,act='relu',model_type='birnn') 

...
train_dataset = TransformerDataset(train_data, tokenizer,'Description', 'ICD_Code',seq_len)
val_dataset = TransformerDataset(val_data, tokenizer, 'Description', 'ICD_Code', seq_len)
test_dataset = TransformerDataset(test_data, tokenizer,'Description', 'ICD_Code', seq_len)
